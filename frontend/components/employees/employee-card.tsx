    ...
    >
      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        <div className="flex items-center gap-3 pt-4 border-t border-slate-800/50 mt-auto">
          ...
          <Link 
            href={`/employees/${employee.id}`}
            className="flex-1 bg-cyan-950/40 hover:bg-cyan-900/60 border border-cyan-500/30 text-cyan-400 py-2 rounded flex items-center justify-center gap-2 text-xs font-semibold transition-colors neon-text-cyan group-hover:neon-border-cyan"
          >
